...
def regist():
    ...
    lid =tk.Label(reg, text="name", bg="white",anchor='w', font=("Arial", 12),justify='right', width=5, height=2).place(x=100,y=40,width=200,height=30)
    lpasd =tk.Label(reg, text="paswd", bg="white", anchor='w',font=("Arial", 12), width=5, height=2).place(x=100,y=120,width=200,height=30)
    lname =tk.Label(reg, text="paswd again", bg="white", anchor='w',font=("Arial", 12),justify='right', width=5, height=2).place(x=100,y=200,width=200,height=40)
    lage =tk.Label(reg, text="other", bg="white", anchor='w',font=("Arial", 12), width=5, height=2).place(x=100,y=280,width=200,height=40)
    ...
    enpasd=tk.Entry(reg,text='input your address',textvariable=v1n_pswd, bg="white",show='*').place(x=100,y=150,width=200,height=30)
    enname=tk.Entry(reg,text='input your name', textvariable=v1n_name,bg="white",show='*').place(x=100,y=230,width=200,height=30)
